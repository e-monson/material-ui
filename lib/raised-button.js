...
var RaisedButton = _react2.default.createClass({
  ...
  _handleKeyboardFocus: function _handleKeyboardFocus(styles) {
    return function (e, keyboardFocused) {
  ...
  render: function render() {
    ...
    var other = _objectWithoutProperties(_props, ['children', 'className', 'disabled', 'icon', 'label', 'labelPosition', 'labelStyle', 'primary', 'secondary']);
